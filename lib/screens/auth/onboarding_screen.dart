          ...
          child: SingleChildScrollView(
            child: Padding(
              ...
              child: Stack(
                ...
                children: [
                  Icon(Icons.eco_outlined, size: 140,
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: AppTheme.bodyStyle(
                          fontSize: 18, color: AppColors.kinInk.withValues(alpha: 0.6), height: 1.5),
                        textAlign: TextAlign.center,
                      ),
                      const SizedBox(height: 48),
                      SizedBox(
                      ...
                      TextButton(
                        ...
                        child: Text('I have an account',
                            style: AppTheme.bodyStyle(color: AppColors.primaryTeal, fontWeight: FontWeight.w600, fontSize: 18)),
                      ),
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text('SECURE & REGULATED',
                                style: AppTheme.labelStyle(color: AppColors.kinInk, letterSpacing: 1.2, fontSize: 12)),
                          ],
                        ),
                      ),
                      const SizedBox(height: 16),
                      Text(
                        ...
                        style: AppTheme.bodyStyle(fontSize: 13, color: AppColors.kinInk.withValues(alpha: 0.6),
