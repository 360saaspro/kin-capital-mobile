...
class AdminChatThreadScreen extends StatefulWidget {
  final String chatId;
  const AdminChatThreadScreen({super.key, required this.chatId});
...
class _AdminChatThreadScreenState extends State<AdminChatThreadScreen> {
  ...
  void _sendMessage() {
    ...
    _controller.clear();
    // Use the admin's uid as senderId, but keep chatId as the document ID
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Chat: ${widget.chatId}', style: AppTheme.headingStyle(fontSize: 16)),
        centerTitle: true,
      ),
      body: Column(
        children: [
